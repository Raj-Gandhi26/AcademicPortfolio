...
const Leadership = () => {
  const experiences = [
    {
      icon: Award,
      title: "Project Lead – Emergency Medical QR Portal (ACM Hackathon 2024; 2nd Place)",
      description: "I led the technical development of the Emergency Medical QR Portal during ACM Hackathon 2024, where our team secured 2nd place. I designed the backend architecture using Flask and PostgreSQL and ensured the emergency workflow remained fast, secure, and intuitive.",
      bullets: [
